	...
	.quebra{
		...
		<div class="quebra">
			<blockquote class="quote-externo container">
				<p><?php the_field('footer_frase', $contato);?></p>
				<cite><?php the_field('footer_autor', $contato);?></cite>
			</blockquote>
		</div>
			...
			<div class="footer">
				<div class="container">
					...
					<div class="grid-8 footer_historia">
						...
						<p><?php the_field('resumo_historia');?></p>
					</div>
					...
					<div class="grid-4 footer_contato">
						...
						<ul>
							...
							<li>- <?php the_field('endereco_bairro', $contato);?></li>
						</ul>
					</div>
